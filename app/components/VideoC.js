  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showControls && (
          <motion.div
            className="absolute bottom-0 mx-auto max-w-xl left-0 right-0 p-2 sm:p-4 m-1.5 sm:m-2 bg-[#11111198] backdrop-blur-md rounded-xl sm:rounded-2xl"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                >
                  <button
                    onClick={togglePlay}
                    className="text-white hover:bg-[#111111d1] p-1 sm:p-2 rounded-md"
                  >
                    {isPlaying ? (
                ...
                <div className="flex items-center gap-x-1">
                  ...
                  >
                    ...
                    >
                      {isMuted ? (
                        <VolumeX className="h-3.5 w-3.5 sm:h-5 sm:w-5" />
                      ) : volume > 0.5 ? (
                        <Volume2 className="h-3.5 w-3.5 sm:h-5 sm:w-5" />
                      ) : (
                        <Volume1 className="h-3.5 w-3.5 sm:h-5 sm:w-5" />
                      )}
                    </button>
                  </motion.div>
                ...
                {[0.5, 1, 1.5, 2].map((speed) => (
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        "text-white hover:bg-[#111111d1] px-1 py-0.5 sm:p-2 rounded-md text-[10px] sm:text-sm",
